...
{
    [AutoloadHead]
    public class FavoredOne : ModNPC
    {
    ...
    public class FavoredOneProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("HouseOfWisdom/Content/NPCs/TownNPCs/FavoredOne");

            if (npc.altTexture == 1)
                return ModContent.Request<Texture2D>("HouseOfWisdom/Content/NPCs/TownNPCs/FavoredOne_Party");

            return ModContent.Request<Texture2D>("HouseOfWisdom/Content/NPCs/TownNPCs/FavoredOne");
        }

        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("HouseOfWisdom/Content/NPCs/TownNPCs/FavoredOne_Head");
    }
}
